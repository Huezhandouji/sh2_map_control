...
execute as @a[team=shadow] positioned -458 7 -127 if entity @s[distance=..10] run scoreboard players add in_point_shadow_population system 1
execute as @a[team=hunter] positioned -458 7 -127 if entity @s[distance=..10] run scoreboard players add in_point_hunter_population system 1
...
#增减占领值
execute positioned -458 7 -127 as @a[team=hunter,distance=..10,scores={in_battle=1}] run scoreboard players add hunter_stronghold_occupy_value system 1
execute if score hunter_stronghold_occupy_value system matches 1.. positioned -458 7 -127 as @a[team=shadow,distance=..10,scores={in_battle=1}] run scoreboard players remove hunter_stronghold_occupy_value system 1
execute if score second system matches 20 positioned -458 7 -127 run function sh2:process_control/battle/sec4/point/particle2
