...
execute as @a[team=shadow] positioned -475.5 33 -129.5 if entity @s[distance=..10] run scoreboard players add in_point_shadow_population system 1
execute as @a[team=hunter] positioned -475.5 33 -129.5 if entity @s[distance=..10] run scoreboard players add in_point_hunter_population system 1
...
#增减占领值
execute positioned -475.5 33 -129.5 as @a[team=hunter,distance=..10,scores={in_battle=1}] run scoreboard players add hunter_stronghold_occupy_value system 1
