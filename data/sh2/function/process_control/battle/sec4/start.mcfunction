scoreboard players set battle_phase system 4
#影§
...
summon text_display 71 74 -134 {"text":[{"text":"§c建筑工地\n敌方控制"}],"billboard":"center","see_through":true,Tags:["sec4_shadow","4"]}
summon text_display 71 74 -138 {"text":[{"text":"§a防守据点"}],"billboard":"center","see_through":true,Tags:["sec4_shadow","5"]}
summon text_display 71 75 -138 {"text":[{"text":"§d前线影庭§7[未升级]\n§a可以部署"}],"billboard":"center","see_through":true,Tags:["sec4_shadow","5_"]}
summon text_display 81 77 -140 {"text":[{"text":"§a写字楼-主庭位置\n友方控制"}],"billboard":"center","see_through":true,Tags:["sec4_shadow","6"]}
execute as @e[tag=sec4_shadow,type=text_display,tag=!5_] run data modify entity @s transformation.scale set value [2,2,2]
...
summon text_display 57 72 -224 {"text":[{"text":"§a建筑工地\n友方控制"}],"billboard":"center","see_through":true,Tags:["sec4_hunter","4"]}
summon text_display 58 72 -228 {"text":[{"text":"§e进攻据点"}],"billboard":"center","see_through":true,Tags:["sec4_hunter","5"]}
summon text_display 58 73 -228 {"text":[{"text":"§c前线影庭§7[未升级]\n§c进攻"}],"billboard":"center","see_through":true,Tags:["sec4_hunter","5_"]}
summon text_display 67 75 -230 {"text":[{"text":"§c写字楼-主庭位置\n敌方控制"}],"billboard":"center","see_through":true,Tags:["sec4_hunter","6"]}
execute as @e[tag=sec4_hunter,type=text_display,tag=!5_] run data modify entity @s transformation.scale set value [2,2,2]
...
#在楼上楼下放置结构1 3
place template sec4_1 -491 29 -141 none none 1 0 strict
place template sec4_3 -468 6 -139 none none 1 0 strict
kill @e[type=item]