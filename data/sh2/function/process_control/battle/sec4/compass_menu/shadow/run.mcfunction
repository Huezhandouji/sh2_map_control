...
execute if entity @s[tag=!player_execute_close_char_menu,scores={trigger_battle_menu=1..}] run function sh2:process_control/battle/sec4/compass_menu/shadow/main_menu
