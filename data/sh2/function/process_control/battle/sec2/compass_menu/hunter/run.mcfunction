...
execute if entity @s[tag=!player_execute_close_char_menu,scores={trigger_battle_menu=1..}] run function sh2:process_control/battle/sec2/compass_menu/hunter/main_menu
...
execute as @s[scores={conditions=3,trigger_battle_menu=1}] at @s run function sh2:process_control/battle/sec2/compass_menu/hunter/start_build_base
