advancement revoke @s only sh2:use_event/deploy/sec2/shadow/4
#没有选择角色的话就return
...
spreadplayers -349.5 -35.5 0 20 under 11 false @s
title @s times 0 40 0
title @s title ""
title @s subtitle "§a部署成功"
tellraw @s [{"text":"§d#####部署成功#####"}]
tellraw @s [{"text":"§a你在§e后方部署点[暗影教堂和建筑工地中间的高速公路底部]§a部署"}]
