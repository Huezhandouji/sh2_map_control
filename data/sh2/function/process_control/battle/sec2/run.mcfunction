...
#部署
#影
execute as @a[team=shadow,scores={in_battle=0}] at @s run function sh2:process_control/battle/sec2/deploy/shadow
execute as @a[team=hunter,scores={in_battle=0}] at @s run function sh2:process_control/battle/sec2/deploy/hunter

#区域状态
#临时当区域范围的粒子
execute if score second system matches 20 positioned -199.5 13 -38.5 run function sh2:process_control/battle/sec2/point/particle3
#设置bossbar和粒子
...
execute if score second system matches 20 if score point_status system matches 1..2 positioned -199.5 15 -38.5 run function sh2:process_control/battle/sec2/point/particle
...
execute if score second system matches 20 if score point_status system matches 2 positioned -199.5 12 -38.5 run particle explosion
execute if score second system matches 20 if score point_status system matches 2 positioned -199.5 13 -38.5 run particle explosion

execute if score point_status system matches 1..2 if score shadow_front_umbracore_destory_value system matches ..0 run function sh2:process_control/battle/sec2/point/umbracore_destory

bossbar set hunter_display name [{"text":"§e猎影人TICKET数量 "},{"score":{"name":"hunter_ticket","objective":"system"}}]
#指南针菜单
# 猎影人
execute as @a[scores={in_battle=1},team=hunter] at @s run function sh2:process_control/battle/sec2/compass_menu/hunter/run
# 影
execute as @a[scores={in_battle=1},team=shadow] at @s run function sh2:process_control/battle/sec2/compass_menu/shadow/run

#猎影人建造地基
execute if score point_status system matches 3 as @a[scores={build_countdown=0..200},team=hunter] at @s run function sh2:process_control/battle/sec2/point/building_base

execute if score point_status system matches 4 run function sh2:process_control/battle/sec2/point/occupying
#影重建前线影庭
execute if score point_status system matches 3 as @a[scores={build_countdown=0..200},team=shadow] at @s run function sh2:process_control/battle/sec2/point/rebuilding_umbracore
#影升级前线影庭
execute if score point_status system matches 1 as @a[scores={build_countdown=0..200},team=shadow] at @s run function sh2:process_control/battle/sec2/point/upgrading_umbracore
