...
execute if entity @s[tag=!player_execute_close_char_menu,scores={trigger_battle_menu=1..}] run function sh2:process_control/battle/sec3/compass_menu/shadow/main_menu
...
#升级影庭
execute positioned -461.5 6 -47.5 if entity @s[distance=..10,scores={trigger_battle_menu=2}] run scoreboard players add @s conditions 1
