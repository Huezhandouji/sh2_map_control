...
execute if entity @s[tag=!player_execute_close_char_menu,scores={trigger_battle_menu=1..}] run function sh2:process_control/battle/sec3/compass_menu/hunter/main_menu
tag @s[tag=player_execute_close_char_menu] remove player_execute_close_char_menu

#建立地基
execute positioned -461.5 6 -47.5 if entity @s[distance=..10,scores={trigger_battle_menu=1}] run scoreboard players add @s conditions 1
...
execute as @s[scores={conditions=3,trigger_battle_menu=1}] at @s run function sh2:process_control/battle/sec3/compass_menu/hunter/start_build_base
