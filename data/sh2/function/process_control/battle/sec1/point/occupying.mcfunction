...
execute as @a[team=shadow] positioned 5323 8 5373 if entity @s[distance=..10] run scoreboard players add in_point_shadow_population system 1
execute as @a[team=hunter] positioned 5323 8 5373 if entity @s[distance=..10] run scoreboard players add in_point_hunter_population system 1
...
#增减占领值
execute positioned 5323 8 5373 as @a[team=hunter,distance=..10] run scoreboard players add hunter_stronghold_occupy_value system 1
execute if score hunter_stronghold_occupy_value system matches 1.. positioned 5323 8 5373 as @a[team=shadow,distance=..10] run scoreboard players remove hunter_stronghold_occupy_value system 1