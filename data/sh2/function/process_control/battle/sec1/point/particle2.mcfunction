...
execute as @e[type=armor_stand,tag=front_umbracore_1_particle] at @s positioned ^ ^-1000 ^5 run particle dust{"color":12828681,"scale":2}
execute as @e[type=armor_stand,tag=front_umbracore_1_particle] at @s positioned ^ ^-1002 ^5 run particle dust{"color":12828681,"scale":2}
...
execute as @e[type=armor_stand,tag=front_umbracore_1_particle] at @s run function sh2:process_control/battle/sec1/point/particle2