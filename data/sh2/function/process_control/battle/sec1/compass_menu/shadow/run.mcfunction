...
execute as @s[scores={conditions=3,trigger_battle_menu=1}] at @s run function sh2:process_control/battle/sec1/compass_menu/shadow/start_rebuild_umbracore
...
#升级影庭
execute positioned -243.5 6 73.5 if entity @s[distance=..10,scores={trigger_battle_menu=2}] run scoreboard players add @s conditions 1
...
execute as @s[scores={conditions=3,trigger_battle_menu=2}] at @s run function sh2:process_control/battle/sec1/compass_menu/shadow/start_upgrade_umbracore
