...
execute if score point_status system matches 1..2 run data modify entity @e[type=text_display,tag=sec1_hunter,tag=2,limit=1] text set value [{"text":"§e进攻据点§c[敌方控制]"}]
execute if score point_status system matches 3 run data modify entity @e[type=text_display,tag=sec1_hunter,tag=2,limit=1] text set value [{"text":"§e进攻据点§h[中立]"}]
...
execute if score point_status system matches 4.. run data modify entity @e[type=text_display,tag=sec1_hunter,tag=2,limit=1] text set value [{"text":"§e进攻据点§a[地基建立]"}]
