...
execute if score point_status system matches 1..2 run data modify entity @e[type=text_display,tag=sec1_shadow,tag=2,limit=1] text set value [{"text":"§a小型社区-防守据点[友方控制]"}]
execute if score point_status system matches 3 run data modify entity @e[type=text_display,tag=sec1_shadow,tag=2,limit=1] text set value [{"text":"§e小型社区-防守据点[中立]"}]
...
execute if score point_status system matches 4 run data modify entity @e[type=text_display,tag=sec1_shadow,tag=2,limit=1] text set value [{"text":"§c小型社区-防守据点[失去完全控制]"}]
...
#猎影人
execute if score point_status system matches 1 run data modify entity @e[type=text_display,tag=sec1_hunter,tag=2_,limit=1] text set value [{"text":"§c前线影庭§7[未升级]\n§d摧毁值"},{"score":{"name":"shadow_front_umbracore_destory_value","objective":"system"}},{"text":"\n§c进攻"}]
execute if score point_status system matches 2 run data modify entity @e[type=text_display,tag=sec1_hunter,tag=2_,limit=1] text set value [{"text":"§c前线影庭[已升级]\n§d摧毁值"},{"score":{"name":"shadow_front_umbracore_destory_value","objective":"system"}},{"text":"\n§c进攻"}]
execute if score point_status system matches 1..2 run data modify entity @e[type=text_display,tag=sec1_hunter,tag=2,limit=1] text set value [{"text":"§e小型社区-进攻据点§c[敌方控制]"}]
execute if score point_status system matches 3 run data modify entity @e[type=text_display,tag=sec1_hunter,tag=2,limit=1] text set value [{"text":"§e小型社区-进攻据点§h[中立]"}]
execute if score point_status system matches 3 run data modify entity @e[type=text_display,tag=sec1_hunter,tag=2_,limit=1] text set value [{"text":"中立状态"}]
execute if score point_status system matches 4.. run data modify entity @e[type=text_display,tag=sec1_hunter,tag=2,limit=1] text set value [{"text":"§e小型社区-进攻据点§a[地基建立]"}]
execute if score point_status system matches 4.. run data modify entity @e[type=text_display,tag=sec1_hunter,tag=2_,limit=1] text set value [{"text":"§a友方地基\n§e占领值"},{"score":{"name":"hunter_stronghold_occupy_value","objective":"system"}},{"text":"\n§c进攻"}]
#部署
#影
...
execute if score second system matches 20 if score point_status system matches 2 positioned -243.5 9 73.5 run particle explosion
execute if score second system matches 20 if score point_status system matches 2 positioned -243.5 12 73.5 run particle explosion
