...
summon text_display 83 74 -134 {"text":[{"text":"§a暗影教堂\n友方控制"}],"billboard":"center","see_through":true,Tags:["sec1_shadow","3"]}

summon text_display 71 74 -134 {"text":[{"text":"§a建筑工地\n友方控制"}],"billboard":"center","see_through":true,Tags:["sec1_shadow","4"]}
summon text_display 71 74 -138 {"text":[{"text":"§a酒店\n友方控制"}],"billboard":"center","see_through":true,Tags:["sec1_shadow","5"]}
summon text_display 81 77 -140 {"text":[{"text":"§a写字楼-主庭位置\n友方控制"}],"billboard":"center","see_through":true,Tags:["sec1_shadow","6"]}
...
summon text_display 69 72 -224 {"text":[{"text":"§c暗影教堂\n敌方控制"}],"billboard":"center","see_through":true,Tags:["sec1_hunter","3"]}
summon text_display 57 72 -224 {"text":[{"text":"§c建筑工地\n敌方控制"}],"billboard":"center","see_through":true,Tags:["sec1_hunter","4"]}
summon text_display 58 72 -228 {"text":[{"text":"§c酒店\n敌方控制"}],"billboard":"center","see_through":true,Tags:["sec1_hunter","5"]}
summon text_display 67 75 -230 {"text":[{"text":"§c写字楼-主庭位置\n敌方控制"}],"billboard":"center","see_through":true,Tags:["sec1_hunter","6"]}
execute as @e[tag=sec1_hunter,type=text_display,tag=!2_,tag=!3_] run data modify entity @s transformation.scale set value [2,2,2]
