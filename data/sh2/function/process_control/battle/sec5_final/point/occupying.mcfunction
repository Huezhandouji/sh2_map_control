...
execute positioned -276.5 57 -149.5 as @a[distance=..10,team=shadow] run scoreboard players add in_point_shadow_population system 1
execute positioned -276.5 57 -149.5 as @a[distance=..10,team=hunter] run scoreboard players add in_point_hunter_population system 1
execute positioned -276.5 57 -149.5 as @a[distance=..10,team=hunter] run scoreboard players add hunter_stronghold_occupy_value system 1
execute if score hunter_stronghold_occupy_value system matches 1.. positioned -276.5 57 -149.5 as @a[distance=..10,team=shadow] run scoreboard players remove hunter_stronghold_occupy_value system 1

execute if score hunter_stronghold_occupy_value system matches 2000.. run function sh2:process_control/battle/sec5_final/end