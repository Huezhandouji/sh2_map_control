...
tellraw @s[scores={san_punish_countdown=100},team=hunter] [{"text":"§e>>§c你的san值损失到0了! 因此你被添加了5秒的§e[眩晕]§c效果"}]
tellraw @s[scores={san_punish_countdown=100},team=shadow] [{"text":"§e>>§c你的TE值损失到0了! 因此你被添加了5秒的§e[眩晕]§c效果"}]
