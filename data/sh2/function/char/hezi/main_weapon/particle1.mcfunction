...
execute as @e[type=armor_stand,tag=hezi_particle1] at @s positioned ^ ^-1000 ^5 run particle dust{"color":16711680,"scale":2}
...
execute as @e[type=armor_stand,tag=hezi_particle1] at @s run function sh2:char/hezi/main_weapon/particle1