...
item replace entity @s hotbar.1 with barrier[custom_data={"slotholder1":true},item_name=[{"text":""}],attribute_modifiers=[{"id":"ban_attack","amount":-100,"operation":"add_value","type":"attack_damage","slot":"hand"}]]
